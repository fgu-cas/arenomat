...
Feed.prototype.it = function () {
    ...
    if (!this.status) {
      ...
      this.motor.rpm(40).cw().step(3200 / 24 * 47 / 9, function () { // 200 steps, 16 microstepp = 3200 / per round ... 24 holes per round, 47/9 = 47 big wheel, 9 small wheel
	    ...
	    this.disable();
            ...
            if (val < 950) {
              ...
              setTimeout(function () { this.it() }.bind(this), 1);
            }
